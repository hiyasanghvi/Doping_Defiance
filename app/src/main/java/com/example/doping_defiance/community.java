    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        joinChatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Log the selected room to debug
                ...
                if (selectedRoom.equals("Select a room")) {
                    ...
                    return; // Prevent further processing if no room is selected
                } else {
                    // Proceed to the next activity and pass the username and room name
                    Intent intent = new Intent(community.this, community2.class);
                    intent.putExtra("username", username); // Passing username
                    intent.putExtra("ROOM_NAME", selectedRoom); // Passing the selected room
